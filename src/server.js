...
app.post("/api/user/register", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, existingUser, hashedPassword, newUser;
 ...
 * LIST USERS
 */
app.get("/api/user/list", function (_req, res) {
    res.json(users);
});
/**
 * LOGIN
...
app.post("/api/user/login", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, validPassword, token;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, email = _a.email, password = _a.password;
            ...
            case 1:
                ...
                token = jsonwebtoken_1.default.sign({ email: user.email }, SECRET, {
                    expiresIn: "1h"
                });
 ...
 * PRIVATE ROUTE
 */
app.get("/api/private", authMiddleware_1.validateToken, function (_req, res) {
